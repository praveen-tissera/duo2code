...
<body id="page-top">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="<?php echo  base_url('/user/register');?>">Login</a>
                    </li>
                    <li>
    ...
    <!-- Plugin JavaScript -->
    <script src="<?php echo  base_url('/assets/script/jquery.easing.min.js');?>"></script>
    <script src="<?php echo  base_url('/assets/script/jquery.fittext.js');?>"></script>
    <script src="<?php echo  base_url('/assets/script/wow.min.js');?>"></script>

    <!-- Custom Theme JavaScript -->
    <script src="<?php echo  base_url('/assets/script/creative.js');?>"></script>
